/****************************************************************************
** Meta object code from reading C++ file 'SamplePlugin.h'
**
...
#include "../../../../NetworkViewer/GUI/plugins/sample/SamplePlugin.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'SamplePlugin.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SamplePlugin_t, stringdata) + ofs \
...
const QMetaObject SamplePlugin::staticMetaObject = {
    { &BasePlugin::staticMetaObject, qt_meta_stringdata_SamplePlugin.data,
      qt_meta_data_SamplePlugin,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SamplePlugin.stringdata))
