...
{
    /**
      A NETVModuleConfiguration holds all the information of the module and contains a list of \ref NETVVariable.
    ...
    */
    ...
    public:
        ...
        enum {VARIABLE_ACTIVATED,
              VARIABLE_NAME,
              VARIABLE_VALUE_TYPE,
              VARIABLE_MEMORY_TYPE,
        ...
        /**
                Constructor
                \param parent The NETVModuleConfiguration parent, defaults to NULL
            */
        NETVModuleConfiguration(QObject *parent=NULL);


        /**
                Copy constructor
                \param cpy the NETVModuleConfiguration to copy. We will perform a deep copy on variables.
            */
        NETVModuleConfiguration(const NETVModuleConfiguration &cpy);
        ...
        /**
            ...
            */
        NETVModuleConfiguration(int projectID, int codeVersion, int processorID, int moduleState, int tableVersion, int deviceID, QObject *parent=NULL);

        /**
                Will destroy all internal variables.
            */
        virtual ~NETVModuleConfiguration();
        ...
        /**
                \param cpy The NETVModuleConfiguration to copy
            */
        NETVModuleConfiguration& operator= (const NETVModuleConfiguration &cpy);
        ...
        */
        ...
        /**
                ...
                \return NETVVariable* The associated variable
            */
        NETVVariable* operator[] (int index) const;

        /**
                Get a variable with its name.
                \param name The variable's name
                \return NETVVariable* the variable. Returns NULL if the variable was not found.
            */
        NETVVariable* getVariableNamed(QString name);
    ...
    signals:
        ...
        */
        void variableAdded(NETVVariable* variable);

        /**
            Emit the signal when a new variable is added
        */
        void variableRemoved(NETVVariable* variable);
    ...
    public slots:
        ...
        */
        void variableUpdated(NETVVariable *var);

        /**
            Add a variable to the NETVModuleConfiguration
        ...
        */
        void addVariable(NETVVariable *variable);

        /**
            Remove a variable from the NETVModuleConfiguration
            \param variable The variable to remove. The module configuration will delete the variable.
         */
        void removeVariable(NETVVariable *variable);

    protected slots:

        void variableInternalUpdate(NETVVariable *var);

        void variableInternalActivated(bool state, NETVVariable *var);

        void variableInternalTimeUpdated(NETVVariable *var);
    ...
    protected:
        ...
        */
        ...
        QList<NETVVariable*> m_variables;
...
#endif // _NETV_MODULE_CONFIGURATION_H_
